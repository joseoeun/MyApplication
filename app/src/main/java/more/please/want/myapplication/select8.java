...
public class select8 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_select8);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v281);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                imageButton11.setImageResource(R.drawable.t28a);
                imageButton12.setImageResource(R.drawable.t28b);
                imageButton13.setImageResource(R.drawable.t28c);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v282);
