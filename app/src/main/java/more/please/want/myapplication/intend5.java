...
public class intend5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_intend5);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v551);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v552);
        ...
        submit.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(editText2.getText().toString().equals("미국에 가려고 비행기를 탄다.")){
                    mediaPlayer2.start();
                }
                else{
                    mediaPlayer1.start();
        ...
        button.setOnClickListener(new Button.OnClickListener(){
            @Override
            public  void onClick(View v) {
                textView3.setText("미국에 가려고 비행기를 탄다.");
