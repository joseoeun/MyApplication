...
public class select7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_select7);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v271);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                imageButton.setImageResource(R.drawable.q271);
                imageButton9.setImageResource(R.drawable.q272);
                imageButton10.setImageResource(R.drawable.q273);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v272);
