...
public class array7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_array7);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v71);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                imageButton.setImageResource(R.drawable.q71);
                imageButton9.setImageResource(R.drawable.q72);
                imageButton10.setImageResource(R.drawable.q73);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v72);
