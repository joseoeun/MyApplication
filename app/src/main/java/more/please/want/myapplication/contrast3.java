...
public class contrast3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_contrast3);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v131);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                imageButton11.setImageResource(R.drawable.t13a);
                imageButton12.setImageResource(R.drawable.t13b);
                imageButton13.setImageResource(R.drawable.t13c);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v132);
