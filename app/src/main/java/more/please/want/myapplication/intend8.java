...
public class intend8 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_intend8);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v581);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                imageView7.setImageResource(R.drawable.t58);
                imageButton11.setImageResource(R.drawable.t58a);
                imageButton12.setImageResource(R.drawable.t58b);
                imageButton13.setImageResource(R.drawable.t58c);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v582);
