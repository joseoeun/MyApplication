...
public class select2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v221);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                imageButton.setImageResource(R.drawable.q221);
                imageButton9.setImageResource(R.drawable.q222);
                imageButton10.setImageResource(R.drawable.q223);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v222);
