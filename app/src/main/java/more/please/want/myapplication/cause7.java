...
public class cause7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cause7);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v371);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                imageButton.setImageResource(R.drawable.q371);
                imageButton9.setImageResource(R.drawable.q372);
                imageButton10.setImageResource(R.drawable.q373);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v372);
