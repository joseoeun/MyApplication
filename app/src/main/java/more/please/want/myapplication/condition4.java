...
public class condition4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_condition4);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v441);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v442);
        ...
        button.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(textView5.getText().toString().equals("크려면")){
                    mediaPlayer2.start();
