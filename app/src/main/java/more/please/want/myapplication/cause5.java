...
public class cause5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cause5);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v351);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v352);
        ...
        submit.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(editText2.getText().toString().equals("컵을 떨어뜨려서 컵이 깨졌다.")){
                    mediaPlayer2.start();
                }
                else{
                    mediaPlayer1.start();
        ...
        button.setOnClickListener(new Button.OnClickListener(){
            @Override
            public  void onClick(View v) {
                textView3.setText("컵을 떨어뜨려서 컵이 깨졌다.");
