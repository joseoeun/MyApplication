...
public class array9 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_array9);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v91);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v92);
        final MediaPlayer mediaPlayer1 = MediaPlayer.create(this, R.raw.wrong);
        final Button button5 = findViewById(R.id.button5);
        imageButton8.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                textView.setText(" 삼촌은");
                textView.setTextSize(40);
                textView2.setText("축구를 잘한다.");
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if(textView5.getText().toString().equals("똑똑하고")){
                    mediaPlayer2.start();
