...
public class contrast4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_contrast4);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v141);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v142);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                textView.setText(" 의사는 병원에 ");
                textView.setTextSize(30);
                textView2.setText("선생님은 학교에 간다.");
        ...
        button.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(textView5.getText().toString().equals("가지만")){
                    mediaPlayer2.start();
