...
public class array8 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_array8);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v81);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                imageButton11.setImageResource(R.drawable.t8a);
                imageButton12.setImageResource(R.drawable.t8b);
                imageButton13.setImageResource(R.drawable.t8c);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v82);
