...
public class intend9 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_intend9);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v591);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v592);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                textView.setText(" 엄마는 옷을");
                textView.setTextSize(30);
                textView2.setText("방에 들어왔다.");
        ...
        button.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(textView5.getText().toString().equals("입으려고")){
                    mediaPlayer2.start();
