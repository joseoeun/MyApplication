...
public class contrast2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_contrast2);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v121);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                imageButton.setImageResource(R.drawable.q121);
                imageButton9.setImageResource(R.drawable.q122);
                imageButton10.setImageResource(R.drawable.q123);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v122);
