...
public class select9 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_select9);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v291);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v292);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                textView.setText(" 동물원에서 코끼리를");
                textView2.setText("토끼를 보자");
        ...
        button.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(textView5.getText().toString().equals("보거나")){
                    mediaPlayer2.start();
