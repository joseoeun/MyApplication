...
public class condition10 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_condition10);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v501);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this, R.raw.v502);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (editText2.getText().toString().equals("요리사가 되고 싶으면 음식을 좋아해야 한다.")) {
                    mediaPlayer2.start();
                } else {
                    mediaPlayer1.start();
        ...
        button.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                textView3.setText("요리사가 되고 싶으면 음식을 좋아해야 한다.");
