...
public class cause8 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cause8);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v381);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                imageView7.setImageResource(R.drawable.t38);
                imageButton11.setImageResource(R.drawable.t38a);
                imageButton12.setImageResource(R.drawable.t38b);
                imageButton13.setImageResource(R.drawable.t38c);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v382);
