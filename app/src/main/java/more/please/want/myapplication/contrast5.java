...
public class contrast5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_contrast5);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v151);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v152);
        ...
        submit.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(editText2.getText().toString().equals("새는 날지만 호랑이는 걷는다.")){
                    mediaPlayer2.start();
                }
                else{
                    mediaPlayer1.start();
        ...
        button.setOnClickListener(new Button.OnClickListener(){
            @Override
            public  void onClick(View v) {
                textView3.setText("새는 날지만 호랑이는 걷는다.");
