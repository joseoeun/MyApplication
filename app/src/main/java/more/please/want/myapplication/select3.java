...
public class select3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v231);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                imageButton11.setImageResource(R.drawable.t23a);
                imageButton12.setImageResource(R.drawable.t23b);
                imageButton13.setImageResource(R.drawable.t23c);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v232);
