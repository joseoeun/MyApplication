...
public class contrast7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_contrast7);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v171);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                imageButton.setImageResource(R.drawable.q171);
                imageButton9.setImageResource(R.drawable.q172);
                imageButton10.setImageResource(R.drawable.q173);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v172);
