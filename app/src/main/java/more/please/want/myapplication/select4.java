...
public class select4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v241);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v242);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                textView.setText(" 텔레비전을");
                textView2.setText("게임을 하자");
