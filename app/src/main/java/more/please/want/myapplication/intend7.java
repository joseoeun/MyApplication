...
public class intend7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_intend7);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v571);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                imageButton.setImageResource(R.drawable.q571);
                imageButton9.setImageResource(R.drawable.q572);
                imageButton10.setImageResource(R.drawable.q573);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v572);
