...
public class condition2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_condition2);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v421);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                imageButton.setImageResource(R.drawable.is1);
                imageButton9.setImageResource(R.drawable.is2);
                imageButton10.setImageResource(R.drawable.is3);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v422);
