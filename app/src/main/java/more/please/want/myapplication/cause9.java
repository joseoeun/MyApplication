...
public class cause9 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cause9);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v391);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v392);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                textView.setText(" 동생은");
                textView.setTextSize(40);
                textView2.setText("아이스크림을 먹었다.");
        ...
        button.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(textView5.getText().toString().equals("더워서")){
                    mediaPlayer2.start();
