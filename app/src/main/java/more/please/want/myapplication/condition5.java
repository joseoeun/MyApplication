...
public class condition5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_condition5);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v451);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v452);
        ...
        submit.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(editText2.getText().toString().equals("영화를 보려면 영화표가 있어야 한다.")){
                    mediaPlayer2.start();
                }
                else{
                    mediaPlayer1.start();
        ...
        button.setOnClickListener(new Button.OnClickListener(){
            @Override
            public  void onClick(View v) {
                textView3.setText("영화를 보려면 영화표가 있어야 한다.");
