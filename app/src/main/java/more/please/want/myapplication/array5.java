...
public class array5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_array5);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v51);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v52);
        ...
        submit.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(editText2.getText().toString().equals("동생은 잠을 자고 나는 공부를 한다.")){
                    mediaPlayer2.start();
                }
                else{
                    mediaPlayer1.start();
        ...
        button.setOnClickListener(new Button.OnClickListener(){
            @Override
            public  void onClick(View v) {
                textView3.setText("동생은 잠을 자고 나는 공부를 한다.");
