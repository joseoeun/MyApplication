...
public class intend4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_intend4);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v541);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v542);
        ...
        button.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(textView5.getText().toString().equals("건너려고")){
                    mediaPlayer2.start();
