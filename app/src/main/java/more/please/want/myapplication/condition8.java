...
public class condition8 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_condition8);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v481);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                imageView7.setImageResource(R.drawable.is11);
                imageButton11.setImageResource(R.drawable.is111);
                imageButton12.setImageResource(R.drawable.is112);
                imageButton13.setImageResource(R.drawable.is113);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v482);
