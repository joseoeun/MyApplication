...
public class intend3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_intend3);
        final MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.v531);
        ...
        imageButton8.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                imageView7.setImageResource(R.drawable.t53);
                imageButton11.setImageResource(R.drawable.t53a);
                imageButton12.setImageResource(R.drawable.t53b);
                imageButton13.setImageResource(R.drawable.t53c);
        ...
        final MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.v532);
